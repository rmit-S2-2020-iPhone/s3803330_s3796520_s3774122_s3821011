...
class Cocktail {
    ...
    class func createArray() -> [Cocktail]{
        ...
        let cocktail5 = Cocktail(cocktailName: "LIIT", imageName: "cocktail5")
        let cocktail6 = Cocktail(cocktailName: "MOJITO", imageName: "cocktail6")
        let cocktail7 = Cocktail(cocktailName: "MARGARITA", imageName: "cocktail7")
        let cocktail8 = Cocktail(cocktailName: "COSMOPOLITAN", imageName: "cocktail8")
        let cocktail9 = Cocktail(cocktailName: "LIIT", imageName: "cocktail9")
        let cocktail10 = Cocktail(cocktailName: "MOJITO", imageName: "cocktail1")
        let cocktail11 = Cocktail(cocktailName: "MARGARITA", imageName: "cocktail2")
        let cocktail12 = Cocktail(cocktailName: "COSMOPOLITAN", imageName: "cocktail3")
        let cocktail13 = Cocktail(cocktailName: "COSMOPOLITAN", imageName: "cocktail3")
